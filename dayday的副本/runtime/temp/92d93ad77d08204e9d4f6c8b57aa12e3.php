...
<div class="page-container">
    ...
    <form class="form form-horizontal" id="form" method="post">
        ...
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>场控号：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" placeholder="手机号" name ="anchor_phone" value="<?php echo !empty($res['anchor_phone'])?$re['anchor_phone']:''; ?>" placeholder="输入手机号" id="anchor_phone" style="width: 50%" />
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>场控名：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" name ="anchor_name" value="<?php echo !empty($res['anchor_name'])?$re['anchor_name']:''; ?>"  id="anchor_name" style="width: 50%" />
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2"><span class="c-red"></span>账号：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" name ="account" value="<?php echo !empty($res['account'])?$re['account']:''; ?>"  placeholder="字母或数字" id="account" style="width: 30%" />
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2"><span class="c-red"></span>密码：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" name ="password" value="<?php echo !empty($res['password'])?$re['password']:''; ?>"  placeholder="字母或数字" id="password" style="width: 30%" />
            </div>
        </div>
        ...
        <div class="row cl">
            <div class="col-xs-8 col-sm-9 col-xs-offset-4 col-sm-offset-2">
                ...
                <input type="hidden" class="input-text" value="<?php echo !empty($re['control_id'])?$re['control_id']:''; ?>" placeholder=""  name="control_id">
            </div>
        </div>
    </form>
</div>
