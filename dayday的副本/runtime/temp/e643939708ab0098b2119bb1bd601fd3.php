...
[
['href'=>url('Apply/index'),'text'=>'未审列表'],
['href'=>'','text'=>$text]
]
]); ?>
...
<div class="page-container">
    ...
    <form class="form form-horizontal" id="form" method="post">
        ...
        <!--<div class="row cl skin-minimal">-->
            ...
            <!--</div>-->
        <!--</div>-->
        <!--<div id="tag2" class="row tag cl <?php echo !empty($re['b_type']) && $re['b_type']==6?'' : 'hiden'; ?>">-->
        <div id="" class="row tag cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                ...
                <!--<a href="javascript:;;" class="btn btn-primary radius" onclick="add_anchor('添加主播','<?php echo url('Apply/add_anchor'); ?>','4','','510')" >-->
                    <!--<i class="Hui-iconfont">&#xe600;</i><span>添加主播</span>-->
                <!--</a>-->
        ...
        <div id="tag3" class="row tag cl <?php echo !empty($re['b_type']) && $re['b_type']==8?'' : 'hiden'; ?>">
        ...
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2">选择大屏型号：</label>
                ...
                <div class="modal fade bs-example-modal-lg" id="myModal1"  tabindex="-1" role="dialog" aria-labelledby="myModalLabel1" >
                    <div class="modal-dialog modal-lg" role="document">
                        ...
                        <div class="modal-header">
                            ...
                            <h4 class="modal-title" id="myModalLabel1">添加大屏型号</h4>
                        </div>
        ...
        <div class="row cl">
            ...
            <!--<div>-->
                ...
                <!--<input type="button" class="btn btn-primary" onclick="getInput2()">保存</input>-->
                <!--<button type="button" class="btn btn-primary" onclick="getInput2()">保存</button>-->
                ...
                <tr class="text-c" id="goods_id<?php echo $vo['goods_id']; ?>">
                    <td><input type="checkbox" goodname="<?php echo $vo['goods_name']; ?>" goodimg="<?php echo $vo['goods_image']; ?>"  goodprc="<?php echo $vo['goods_price']; ?>"  data-key="<?php echo $key; ?>" value="<?php echo $vo['goods_id']; ?>" name="checkbox"></td>
                    <!--<td><input type="checkbox" goodname="<?php echo $vo['goods_name']; ?>" goodimg="<?php echo $vo['goods_image']; ?>" goodspec="<?php echo $vo['goods_spec']; ?>" goodprc="<?php echo $vo['goods_price']; ?>"  data-key="<?php echo $key; ?>" value="<?php echo $vo['goods_id']; ?>" name="checkbox"></td>-->
        ...
        <div class="cl pd-30 bg-1 bk-gray mt-10" style="margin-left: 100px">
            <table class="table table-border table-bordered table-hover table-bg table-sort">
                ...
                <tr class="text-c">
                    <th width="20">序号</th>
                    <th width="90">名称</th>
                    <th width="50">商品缩略图</th>
                    <!--<th width="50">商品规格</th>-->
                    <th width="50">商品价格</th>
                    <th width="100">淘宝链接</th>
                    <th width="100">京东链接</th>
                </tr>
                </thead>
                <tbody id="showthis">
        ...
        <button style="margin-left: 550px;" type="button" class="btn btn-primary" onclick="getInput2()">保存</button><p style="color: red;margin-left: 630px;margin-top: -30px;">填写完请保持</p>
...
<script type="text/javascript">
    ...
    function screen_add(kid){
        ...
        layer.confirm('确认要添加大屏吗？',function(index){
    ...
    function getChecked(id) {
        ...
        $.each($('input[name="checkbox"]:checked'), function(i, n){
            ...
            gidbox.push({
                ...
                // 'goodspec':$(n).attr('goodspec'),
                'goodprc':$(n).attr('goodprc'),
                'tao_link':$(n).attr('tao_link'),
                'dong_link':$(n).attr('dong_link'),
            })
                    ...
                    for(var i=0;i<gidbox.length;i++){
                        ...
                        $('#showthis').append(
                            '<tr class="text-c  check_data">',
                                ...
                                // '<td style="text-align:center">'+gidbox[i].goodspec+'</td>',
                                '<td style="text-align:center">'+gidbox[i].goodprc+'</td>',
                                `<td style="text-align:center"><input class="tbUrl${gidbox[i].goodsid}" type="text" style="width: 250px;"></td>`,
                                `<td style="text-align:center"><input  class="jdUrl${gidbox[i].goodsid}" type="text" style="width: 250px;"></td>`,
                            '</tr>'
                    )
                    }
                    layer.msg(data.info,{icon:1,time:1000});
    ...
    function getInput2() {
        ...
        for(var i of gidbox){
            var obj = {};
            obj.goods_id = i.goodsid;
            obj.goods_name = i.goodsname;
            obj.goods_image = i.goodimg;
            // obj.goods_spec = i.goodspec;
            obj.goods_price = i.goodprc;
            obj.tbUrl = $('.tbUrl'+i.goodsid).val();
            // obj.tbUrl = '1234ss';
            obj.jdUrl = $('.jdUrl'+i.goodsid).val();
            // obj.jdUrl = '123123ss';
            arrr2.push(obj);
            // console.log(arrr2);
        }
        console.log(arrr2);
        $("#goods").val(JSON.stringify(arrr2));
