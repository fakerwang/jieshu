<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:74:"/mnt2/data/dayday/public/../application/admin/view/screen/edit_screen.html";i:1521182227;s:62:"/mnt2/data/dayday/public/../application/admin/view/layout.html";i:1520221433;s:70:"/mnt2/data/dayday/public/../application/admin/view/common/_header.html";i:1528535116;s:70:"/mnt2/data/dayday/public/../application/admin/view/common/_footer.html";i:1520221433;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
    <meta charset="utf-8">
...
<div class="page-container">
    ...
    <form class="form form-horizontal" id="form" method="post">
        <div class="row cl">
			...
			<select name="screen_class_id" id="seed_class_id" class="select">
				<option value="">型号</option>
				<if condition="!empty($re['seed_class'])">
					<?php if(is_array($screen) || $screen instanceof \think\Collection): if( count($screen)==0 ) : echo "" ;else: foreach($screen as $key=>$v): ?>
						<option value="<?php echo $v['screen_class_id']; ?>" <?php if($re['screen_class_id'] == $v['screen_class_id']): ?>selected<?php endif; ?>><?php echo $v['model']; ?></option>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" name="Mac_address" class="input-text" value="<?php echo !empty($re['Mac_address'])?$re['Mac_address'] : ''; ?>" placeholder="MAC地址" id="Mac_address" />
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>备注：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" name="desc" class="input-text" value="<?php echo !empty($re['desc'])?$re['desc'] : ''; ?>" placeholder="备注" id="desc" />
            </div>
        </div>
        <div class="row cl">
                ...
                editor.loadPlugin('image', function() {
                    editor.plugin.imageDialog({
                        ...
                        clickFn : function(url, title, width, height, border, align) {
                            console.log("<?php echo \think\Config::get('domain'); ?>"+url);
                            $('#image1').css('background-image','url('+url+')').css('background-size','220px 160px');
                            K('#image_1').val("<?php echo \think\Config::get('domain'); ?>"+url);
                            // K('#getImgUrl').val(url);
                            editor.hideDialog();
                        }
                    });
