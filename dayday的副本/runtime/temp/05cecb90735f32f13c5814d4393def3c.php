	...
	<div class="cl pd-6 bg-1 bk-gray mt-20">
		<span class="l">
			<a href="<?php echo url('Apply/add_apply'); ?>"  class="btn btn-primary radius">
				<i class="Hui-iconfont">&#xe600;</i> 添加售卖申请
			</a>
			<a href="<?php echo url('Apply/add_pai_apply'); ?>"  class="btn btn-primary radius">
				<i class="Hui-iconfont">&#xe600;</i> 添加拍卖申请
			</a>
			<a href="<?php echo url('Apply/add_zhan_apply'); ?>"  class="btn btn-primary radius">
				<i class="Hui-iconfont">&#xe600;</i> 展销直播申请
			</a>
		</span>
	...
	<table class="table table-border table-bordered table-hover table-bg table-sort">
		...
		<?php if(is_array($list) || $list instanceof \think\Collection): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
			<tr class="text-c">
				...
				<td>
					<?php switch($name=$vo['is_shenhe']): case "1": ?>未审核<?php break; case "2": ?>审核通过<?php break; endswitch; ?>
				</td>
				<!--<td class="td-manage">-->
					...
					<!--<a title="查看" href="<?php echo url('Apply/edit_apply',['apply_id'=>$vo['apply_id']]); ?>"  class="btn btn-primary radius">-->
