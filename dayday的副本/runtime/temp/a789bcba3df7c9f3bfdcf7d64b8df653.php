<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:71:"/mnt2/data/dayday/public/../application/admin/view/live/edit_apply.html";i:1530244072;s:62:"/mnt2/data/dayday/public/../application/admin/view/layout.html";i:1520221433;s:70:"/mnt2/data/dayday/public/../application/admin/view/common/_header.html";i:1528535116;s:70:"/mnt2/data/dayday/public/../application/admin/view/common/_footer.html";i:1520221433;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
    <meta charset="utf-8">
...
<div class="page-container">
    ...
    <form class="form form-horizontal" id="form" method="post">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <span class="select-box" style="width: 33%">
                    <select name="zhu_phone"  class="select" disabled>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" name ="control_num" value="<?php echo !empty($re['control_num'])?$re['control_num']:''; ?>"  id="control_num" style="width: 50%" />
            </div>
        </div>
        <!--<div class="row cl">-->
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                  <span class="select-box" style="width: 33%">
                    <select name="class_id"  class="select" disabled>
                        <option value="">请选择</option>
        ...
        <!--<div class="row cl skin-minimal">-->
            ...
            <!--<div class="formControls col-xs-8 col-sm-9">-->
                ...
                <!--<div class="check-box">-->
                    <!--<input  type="radio" style="color: red;" id="checkbox-2" name="class_id" value="<?php echo $vo['live_class_id']; ?>"<?php if($vo['live_class_id'] == $re['class_id']): ?>checked<?php endif; ?>><?php echo $re['tag']; ?>-->
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <div class="droparea spot" id="image2" style="background-image: url('<?php echo $screen['img']; ?>');background-size: 220px 160px;" >
                    ...
                    <div id="uparea2"></div>
                    <input type="hidden" name="img" id="image_2" value="<?php echo $screen['img']; ?>" />
                </div>
            </div>
        </div>
        <div class="row cl">
            ...
            <span>
                ...
                <div class="modal fade bs-example-modal-lg" id="myModal"  tabindex="-1" role="dialog" aria-labelledby="myModalLabel" >
                    <div class="modal-dialog modal-lg" role="document">
                        ...
                        <div class="modal-header">
                            ...
                            <h4 class="modal-title" id="myModalLabel">选择大屏</h4>
                        </div>
                ...
                <tr class="text-c" id="goods_id<?php echo $vo['screen_id']; ?>">
                    <td><input type="checkbox" model="<?php echo $vo['model']; ?>" wid_hei="<?php echo $vo['wid_hei']; ?>" touch="<?php echo $vo['touch']; ?>" Mac_address="<?php echo $vo['Mac_address']; ?>" screen_price="<?php echo $vo['screen_price']; ?>" desc="<?php echo $vo['desc']; ?>" value="<?php echo $vo['screen_id']; ?>" name="checkbox"></td>
        ...
        <div class="row cl">
            ...
            <select name="is_shenhe" class="select"  onchange="changeMk(this.value)">
                <option value="">请选择</option>
                <option value="2" <?php echo !empty($re['is_shenhe']) && $re['is_shenhe']==2?'selected' : ''; ?>>审核通过</option>
                <option value="3" <?php echo !empty($re['is_shenhe']) && $re['is_shenhe']==3?'selected' : ''; ?>>拒绝</option>
            </select>
            </div>
            </div>
            <!--<div class="row cl">-->
            <!--<label class="form-label col-xs-4 col-sm-2"><span class="c-red"></span>审核状态：</label>-->
            <!--<div class="formControls col-xs-8 col-sm-9" style="display: inline-block">-->
                <!--<select name="is_shenhe" class="select input-text"  onchange="changeMk(this.value)">-->
                    <!--<option value="1" <?php if($re['is_shenhe'] == 1): ?>selected<?php endif; ?>>未审核</option>-->
                    ...
                    <!--&lt;!&ndash;<option value="4" <?php if($re['is_shenhe'] == 4): ?>selected<?php endif; ?>>正在直播</option>&ndash;&gt;-->
                    <!--&lt;!&ndash;<option value="5" <?php if($re['is_shenhe'] == 5): ?>selected<?php endif; ?>>直播异常</option>&ndash;&gt;-->
                    <!--&lt;!&ndash;<option value="6" <?php if($re['is_shenhe'] == 6): ?>selected<?php endif; ?>>结束活动</option>&ndash;&gt;-->
                <!--</select>-->
            <!--</div>-->
        <!--</div>-->
        <div id="tag3" class="row tag cl <?php echo !empty($re['is_shenhe']) && $re['is_shenhe']==3?'' : 'hiden'; ?>">
                ...
                <div class="formControls col-xs-8 col-sm-9">
                    <textarea name="refusal" cols="" rows="" class="textarea"  placeholder="说点什么...最少输入20个字符" datatype="*10-100" dragonfly="true" nullmsg="拒绝理由不能为空！" onKeyUp="textarealength(this,50)"><?php echo $re['refusal']; ?></textarea>
