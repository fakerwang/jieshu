            ...
            <!--<div class="formControls col-xs-8 col-sm-9">-->
                <!--<span class="select-box" style="width: 33%">-->
                    <!--<select name="status"  class="select">-->
                        ...
                        <!--&lt;!&ndash;<option value="1">拍卖</option>&ndash;&gt;-->
                    <!--</select>-->
				<!--</span>-->
            <!--</div>-->
        <!--</div>-->
