<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:67:"/mnt2/data/dayday/public/../application/admin/view/home/notice.html";i:1527841654;s:62:"/mnt2/data/dayday/public/../application/admin/view/layout.html";i:1520221433;s:70:"/mnt2/data/dayday/public/../application/admin/view/common/_header.html";i:1528535116;s:70:"/mnt2/data/dayday/public/../application/admin/view/common/_footer.html";i:1520221433;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
    <meta charset="utf-8">
...
[
['href'=>url('Home/notice'),'text'=>'系统公告']
]
]); ?>
<div class="page-container">
    <form class="search"  method="get">
        <input type="text" class="input-text" style="width:250px" placeholder="输入公告标题" value="<?php echo $_GET['title']; ?>" name="title">
    ...
    <div class="cl pd-5 bg-1 bk-gray mt-20">
        <span class="l">
            <a href="javascript:;" onclick="datadel()" class="btn btn-danger radius">
                ...
                批量删除</a>
            <a class="btn btn-primary radius"  href="<?php echo url('Home/add_notice'); ?>">
    ...
    <div class="mt-20">
        <table class="table table-border table-bordered table-bg table-hover table-sort">
            ...
            <tr class="text-c">
                ...
                <td><a href="<?php echo url('Home/edit_notice',['id'=>$vo['id']]); ?>"><u><?php echo $vo['title']; ?></u></a></td>
                <td>
                    <a href="javascript:void(0)" onclick="change_istop(<?php echo $vo['id']; ?>,this)">
                        <u>
                        <?php if($vo['is_top'] == 1): ?>
                ...
                <td class="td-manage">
                    <?php if($vo['state'] == 1): ?>
                    <a style="text-decoration:none" onClick="picture_start(this,<?php echo $vo['id']; ?>)" href="javascript:;" title="发布">
                        <i class="Hui-iconfont">&#xe603;</i>
                    </a>
                    <?php else: ?>
                    ...
                    <?php endif; ?>
                    <a style="text-decoration:none" class="ml-5"  href="<?php echo url('Home/edit_notice',['id'=>$vo['id']]); ?>" title="编辑">
                        <i class="Hui-iconfont">&#xe6df;</i>
                    </a>
...
<script type="text/javascript">
    ...
    function datadel(kid){
        ...
        $.post("<?php echo url('Home/del_notice'); ?>", {ids:kid}, function(data){
            if( data.status == 'ok' ){
    ...
    function picture_stop(obj,id){
        layer.confirm('确认要下架吗？',function(index){
            $.post("<?php echo url('Home/change_notice_state'); ?>",{id:id},function(data){
                console.log(data);
                if(data.data==1){
    ...
    function change_istop(id,v){
        layer.confirm('确认要改变置顶状态吗？',function(index) {
            console.log(id);
            $.post("<?php echo url('Home/change_notice_top'); ?>", {id: id}, function (data) {
                if (data['status'] == 'ok') {
                    if(data.data==1){
    ...
    function picture_del(obj,id){
        layer.confirm('确认要删除吗？',function(index){
            $.post("<?php echo url('Home/del_notice'); ?>", {ids:id}, function(data){
                if( data.status == 'ok' ){
