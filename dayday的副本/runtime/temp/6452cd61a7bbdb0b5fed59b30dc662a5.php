...
<div class="page-container">
    ...
    <div class="cl pd-5 bg-1 bk-gray mt-20">
		<span class="l">
			...
			<a href="<?php echo url('Role/add_anchor'); ?>"  class="btn btn-primary radius">
    ...
    <div class="mt-20">
        <table class="table table-border table-bordered table-hover table-bg table-sort">
            ...
            <tr class="text-c">
                ...
                <!--</td>-->
                <td>
                    <a title="个人详情" href="<?php echo url('role/anchor_view',['mid'=>$vo['anchor_id']]); ?>"  class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe705;</i></a>
...
<script type="text/javascript">
    ...
    function change_review(obj,id){
        layer.confirm('确认要操作吗？',function(index){
            $.post("<?php echo url('Role/change_anchor_review'); ?>",{id:id},function(data){
                console.log(data);
                if(data.data==2){
