...
<div class="page-container">
    ...
    <form class="form form-horizontal" id="form" method="post">
        ...
        <div id="tag3" class="row tag cl <?php echo !empty($re['is_shenhe']) && $re['is_shenhe']==3?'' : 'hiden'; ?>">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <textarea name="anchor_refusal" cols="" rows="" class="textarea"  placeholder="说点什么...最少输入20个字符" datatype="*10-100" dragonfly="true" nullmsg="拒绝理由不能为空！" onKeyUp="textarealength(this,50)"><?php echo $re['anchor_refusal']; ?></textarea>
