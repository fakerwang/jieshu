<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:76:"/mnt2/data/dayday/public/../application/admin/view/merchants/apply_list.html";i:1530015804;s:62:"/mnt2/data/dayday/public/../application/admin/view/layout.html";i:1520221433;s:70:"/mnt2/data/dayday/public/../application/admin/view/common/_header.html";i:1528535116;s:70:"/mnt2/data/dayday/public/../application/admin/view/common/_footer.html";i:1520221433;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
    <meta charset="utf-8">
...
<div class="page-container">
    <div class="text-l">
        <form class="search"  method="get">
            <input type="text" class="input-text" style="width:250px" placeholder="输入会员名称、电话、邮箱" value="<?php echo !empty($_GET['username'])?$_GET['username']:''; ?>" name="username">
    ...
    <div class="cl pd-5 bg-1 bk-gray mt-20">
		<span class="l">
			...
			<!--<a href="<?php echo url('Member/add_member'); ?>"  class="btn btn-primary radius">-->
    ...
    <div class="mt-20">
        <table class="table table-border table-bordered table-hover table-bg table-sort">
            ...
            <tr class="text-c">
                ...
                <td>
                    <!--<a title="商户详情" href="<?php echo url('Member/view',['mid'=>$vo['member_id'],'type'=>1]); ?>"  class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe705;</i></a>-->
                    <a title="商户审核" href="<?php echo url('merchants/edit_merchant',['mid'=>$vo['gl_merchants_id']]); ?>"  class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6df;</i></a>
