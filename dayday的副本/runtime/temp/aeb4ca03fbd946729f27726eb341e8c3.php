<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:72:"/mnt2/data/dayday/public/../application/admin/view/live/edit_applys.html";i:1530244055;s:62:"/mnt2/data/dayday/public/../application/admin/view/layout.html";i:1520221433;s:70:"/mnt2/data/dayday/public/../application/admin/view/common/_header.html";i:1528535116;s:70:"/mnt2/data/dayday/public/../application/admin/view/common/_footer.html";i:1520221433;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
    <meta charset="utf-8">
        ...
        <!--</div>-->
            ...
            <div class="formControls col-xs-8 col-sm-9" style="display: inline-block">
                <select name="is_shenhe" class="select input-text" disabled>
                    ...
                    <option value="6" <?php if($re['is_shenhe'] == 6): ?>selected<?php endif; ?>>结束活动</option>
                </select>
            </div>
        </div>
        <div id="tag3" class="row tag cl <?php echo !empty($re['is_shenhe']) && $re['is_shenhe']==3?'' : 'hiden'; ?>">
