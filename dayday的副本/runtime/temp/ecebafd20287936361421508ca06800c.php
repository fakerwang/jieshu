<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:71:"/mnt2/data/dayday/public/../application/admin/view/home/home_class.html";i:1529923542;s:62:"/mnt2/data/dayday/public/../application/admin/view/layout.html";i:1520221433;s:70:"/mnt2/data/dayday/public/../application/admin/view/common/_header.html";i:1528535116;s:70:"/mnt2/data/dayday/public/../application/admin/view/common/_footer.html";i:1520221433;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
    <meta charset="utf-8">
...
[
['href'=>url('Home/home_class'),'text'=>'首页分类']
]
]); ?>
    ...
    <!--<div class="cl pd-5 bg-1 bk-gray">-->
        <!--<span class="l">-->
            <!--<a href="javascript:;" onclick="datadel()" class="btn btn-danger radius">-->
                ...
                <!--批量删除</a>-->
            <!--<a class="btn btn-primary radius"  href="<?php echo url('Home/add_home_class'); ?>">-->
    ...
    <div class="mt-20">
        <table class="table table-border table-bordered table-bg table-hover table-sort">
            ...
            <tr class="text-c">
                ...
                <td><a href="<?php echo url('Home/edit_home_class',['id'=>$vo['id']]); ?>"><u><?php echo $vo['title']; ?></u></a></td>
                ...
                <td class="td-manage">
                    ...
                    <!--</a>-->
                    <!--<?php endif; ?>-->
                    <a style="text-decoration:none" class="ml-5"  href="<?php echo url('Home/edit_home_class',['id'=>$vo['id']]); ?>" title="编辑">
                        <i class="Hui-iconfont">&#xe6df;</i>
                    </a>
...
<script type="text/javascript">
    ...
    function datadel(kid){
        ...
        $.post("<?php echo url('Home/del_home_class'); ?>", {ids:kid}, function(data){
            if( data.status == 'ok' ){
                console.log(data);
    ...
    function picture_stop(obj,id){
        layer.confirm('确认要下架吗？',function(index){
            $.post("<?php echo url('Home/change_class_status'); ?>",{id:id},function(data){
                if(data.data.info==1){
    ...
    function plus(v){
        $.post("<?php echo url('Home/plus_class_sort'); ?>",{id:v},function(data){
            if(data['status'] == 'ok'){
    ...
    function minus(v){
        $.post("<?php echo url('Home/minus_class_sort'); ?>",{id:v},function(data){
            if(data['status'] == 'ok'){
                layer.msg(data.data,{icon:1,time:2000})
                window.location.href = window.location.href;
            }else{
    ...
    function picture_del(obj,id){
        layer.confirm('确认要删除吗？',function(index){
            $.post("<?php echo url('Home/del_home_class'); ?>", {ids:id}, function(data){
                if( data.status == 'ok' ){
