...
<div class="page-container">
    ...
    <form class="form form-horizontal" id="form" method="post">
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2"><span class="c-red"></span>主播ID：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <span><?php echo $data['anchor_id']; ?></span>
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2"><span class="c-red"></span>主播名：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <span><?php echo $data['anchor_name']; ?></span>
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2"><span class="c-red"></span>主播账号：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" name ="account" value="<?php echo !empty($re['account'])?$re['account']:''; ?>"  placeholder="字母或数字" id="account" style="width: 30%" />
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2"><span class="c-red"></span>主播密码：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" name ="password" value="<?php echo !empty($re['password'])?$re['password']:''; ?>"  placeholder="字母或数字" id="password" style="width: 30%" />
            </div>
        </div>
        <div class="row cl">
