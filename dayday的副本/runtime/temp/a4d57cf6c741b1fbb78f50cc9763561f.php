<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:67:"/mnt2/data/dayday/public/../application/admin/view/live/anchor.html";i:1530241254;s:62:"/mnt2/data/dayday/public/../application/admin/view/layout.html";i:1520221433;s:70:"/mnt2/data/dayday/public/../application/admin/view/common/_header.html";i:1528535116;s:70:"/mnt2/data/dayday/public/../application/admin/view/common/_footer.html";i:1520221433;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
    <meta charset="utf-8">
    ...
    <div class="mt-20">
        <table class="table table-border table-bordered table-hover table-bg table-sort">
            ...
            <tr class="text-c">
                ...
                <td>
                    <?php switch($name=$vo['is_shenhe']): case "1": ?>未审核<?php break; case "2": ?>审核通过<?php break; case "3": ?>拒绝<?php break; case "4": ?>直播中<?php break; endswitch; ?>
                    <!--<a title="编辑" href="<?php echo url('role/edit_anchor',['anchor_id'=>$vo['anchor_id']]); ?>"  class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6df;</i></a>-->
                ...
                <td>
                <?php if($vo['jin_type'] == 2): ?>
                <u><a href="javascript:;;" onClick="change_review(this,<?php echo $vo['anchor_id']; ?>)"><span class="label label-success radius">是</span></a></u>
                <?php else: ?>
                <u><a href="javascript:;;" onClick="change_review(this,<?php echo $vo['anchor_id']; ?>)"><span class="label label-defaunt radius">否</span></a></u>
                <?php endif; ?>
                </td>
                <td>
                    <a title="个人详情" href="<?php echo url('Live/anchor_view',['mid'=>$vo['anchor_id']]); ?>"  class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe705;</i></a>
                    <a title="编辑" href="<?php echo url('Live/edit_anchors',['anchor_id'=>$vo['anchor_id']]); ?>"  class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6df;</i></a>
                </td>
            </tr>
    ...
    function change_review(obj,id){
        layer.confirm('确认要操作吗？',function(index){
            $.post("<?php echo url('Live/change_anchor_review'); ?>",{id:id},function(data){
                console.log(data);
                if(data.data==2){
                    $(obj).parents("td").html('<u><a href="javascript:;;" onClick="change_review(this,'+id+')"><span class="label label-success radius">是</span></a></u>');
                    layer.msg('操作成功!',{icon: 6,time:1000});
                }else if(data.data == 0){
                    $(obj).parents("td").html('<u><a href="javascript:;;" onClick="change_review(this,'+id+')"><span class="label label-defaunt radius">否</span></a></u>');
                    layer.msg('操作成功!',{icon: 6,time:1000});
                }
            },'json')
        });
