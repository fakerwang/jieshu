<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:75:"/mnt2/data/dayday/public/../application/admin/view/screen/screen_class.html";i:1521183619;s:62:"/mnt2/data/dayday/public/../application/admin/view/layout.html";i:1520221433;s:70:"/mnt2/data/dayday/public/../application/admin/view/common/_header.html";i:1528535116;s:70:"/mnt2/data/dayday/public/../application/admin/view/common/_footer.html";i:1520221433;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
    <meta charset="utf-8">
...
[
['href'=>url('Screen/screen_class'),'text'=>'大屏型号'],
]
]); ?>
<div class="page-container">
    <div class="cl pd-5 bg-1 bk-gray mt-20">
		<span class="l">
			...
			<a href="<?php echo url('Screen/add_class_tag'); ?>"  class="btn btn-primary radius">
				<i class="Hui-iconfont">&#xe600;</i>添加大屏型号
			</a>
		</span>
    ...
    <div class="mt-20">
        <table class="table table-border table-bordered table-hover table-bg table-sort">
            ...
            <tr class="text-c">
                ...
                <td class="td-manage">
                    <a title="编辑" href="<?php echo url('Screen/edit_class_tag',array('screen_class_id'=>$vo['screen_class_id'])); ?>"  class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6df;</i></a>
                    <a title="删除" href="javascript:;" onclick="del(this,'<?php echo $vo['screen_class_id']; ?>')" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6e2;</i></a>
                </td>
            </tr>
...
<script type="text/javascript">
    ...
    function datadel(kid){
        ...
        layer.confirm('确认要删除吗？',function(index){
            $.post("<?php echo url('Config/del_live_tag'); ?>", {ids:kid}, function(data){
                if( data.status == 'ok' ){
    ...
    function eidt_sort(data,id){
        var lid = id;
        var sort = data.value;
        $.post("<?php echo url('Config/edit_sort'); ?>",{id:id,sort:sort},function(data){
            if( data.status == 'ok' ){
    ...
    function del(obj,id){
        layer.confirm('确认要删除吗？',function(index){
            $.post("<?php echo url('Screen/del_live_tag'); ?>", {ids:id}, function(data){
                if( data.status == 'ok' ){
