<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:73:"/mnt2/data/dayday/public/../application/admin/view/screen/add_screen.html";i:1524206367;s:62:"/mnt2/data/dayday/public/../application/admin/view/layout.html";i:1520221433;s:70:"/mnt2/data/dayday/public/../application/admin/view/common/_header.html";i:1528535116;s:70:"/mnt2/data/dayday/public/../application/admin/view/common/_footer.html";i:1520221433;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
    <meta charset="utf-8">
            ...
            <div class="formControls col-xs-8 col-sm-9">
				...
				<select name="screen_class_id" id="screen_class_id"  class="select">
					...
					<?php if(is_array($res) || $res instanceof \think\Collection): $i = 0; $__LIST__ = $res;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
						<option value="<?php echo $vo['screen_class_id']; ?>" <?php if($re['screen_class_id'] == $vo['screen_class_id']): ?>selected<?php endif; ?>><?php echo $vo['model']; ?></option>
