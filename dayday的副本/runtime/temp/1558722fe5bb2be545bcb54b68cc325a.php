...
<div class="page-container">
    <form class="form form-horizontal" id="form" method="post">
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>拍卖师名：</label>
        ...
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>拍卖师描述：</label>
            <div class="formControls col-xs-8 col-sm-9">
        ...
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>拍卖师资质：</label>
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <div class="droparea spot" id="logo_img" style="background-image: url('<?php echo !empty($re['user_img'])?$re['user_img']:''; ?>');background-size: 220px 160px;" >
                    <div class="instructions"><span class="c-red">*</span>拍卖师头像</div>
                    <div id="logo"></div>
                ...
                <div class="droparea spot" id="image2" style="background-image: url('<?php echo !empty($re['user_img2'])?$re['user_img2']:''; ?>');background-size: 220px 160px;" >
                    <div class="instructions"><span class="c-red">*</span>拍卖师资质</div>
                    <div id="uparea2"></div>
                ...
                <div class="droparea spot" id="image3" style="background-image: url('<?php echo !empty($re['user_img3'])?$re['user_img3']:''; ?>');background-size: 220px 160px;" >
                    <div class="instructions">拍卖师资质</div>
                    <div id="uparea3"></div>
