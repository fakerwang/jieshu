<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:71:"/mnt2/data/dayday/public/../application/admin/view/live/apply_data.html";i:1529650573;s:62:"/mnt2/data/dayday/public/../application/admin/view/layout.html";i:1520221433;s:70:"/mnt2/data/dayday/public/../application/admin/view/common/_header.html";i:1528535116;s:70:"/mnt2/data/dayday/public/../application/admin/view/common/_footer.html";i:1520221433;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
    <meta charset="utf-8">
...
[
['href'=>url(''),'text'=>''],
['href'=>url('Live/apply_list'),'text'=>'申请列表'],
]
]); ?>
	...
	<table class="table table-border table-bordered table-hover table-bg table-sort">
		...
		<?php if(is_array($list) || $list instanceof \think\Collection): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
			<tr class="text-c">
				...
				<td>
					<?php switch($name=$vo['is_shenhe']): case "1": ?>未审核<?php break; case "2": ?>审核通过<?php break; case "3": ?>拒绝<?php break; case "4": ?>正在直播<?php break; case "5": ?>正在直播<span style="color:red; ">(异常)</span><?php break; case "6": ?>结束活动<?php break; endswitch; ?>
				</td>
				<td class="td-manage">
					<a title="活动详情" href="<?php echo url('Live/edit_applys',['apply_id'=>$vo['apply_id']]); ?>"  class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6df;</i></a>
				</td>
			</tr>
