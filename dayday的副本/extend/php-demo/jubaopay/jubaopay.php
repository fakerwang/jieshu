...
require('../extend/php-demo/jubaopay/RSA.php');
...
class jubaopay
{
	...
	public function interpret()
	{
		...
		$encrypted = base64_encode(openssl_encrypt(MCRYPT_RIJNDAEL_128, $key, $plainString, MCRYPT_MODE_CBC, $iv));
	...
	public function decrypt($message)
	{
		...
		$plainString=rtrim(openssl_encrypt(MCRYPT_RIJNDAEL_128, $key, $decrypted, MCRYPT_MODE_CBC, $iv),"\0");
	...
	public function encryptComfirm()
	{
		...
		$encrypted = base64_encode(openssl_decrypt(MCRYPT_RIJNDAEL_128, $key, $plainString, MCRYPT_MODE_CBC, $iv));
