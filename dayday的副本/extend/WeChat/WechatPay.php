...
//        $signParams['noncestr'] =$params['nonce_str'];
//        $signParams['package'] =$params['package'];
//        $signParams['partnerid'] = $params['mch_id'];
//        $signParams['timestamp'] = $params['timestamp'];
//        $signParams['prepayid'] = $params['prepay_id'];
//        $Sign = $this->getTowSign($signParams);
//        $params['sign'] = $Sign;
        return success($params);
    }
    //二次签名方法
    function getTowSign($data){
        foreach ($data as $k => $v)
        {
