...
namespace lib;
class Easemob{
    private $client_id = 'YXA6HSJaACdpEeiBM2Es1ICJBQ';
    private $client_secret = 'YXA6HBiiKO6M0n0yU96qYoDup2UPYPY';
    private $org_name = "1126180314253027";
    private $app_name ='daylive';
    private $url = '';
    ...
    public function __construct(){
        $options =[
            'client_id' => 'YXA6HSJaACdpEeiBM2Es1ICJBQ',
            'client_secret' => 'YXA6HBiiKO6M0n0yU96qYoDup2UPYPY',
            'org_name' => "1126180314253027",
            'app_name' =>'daylive',
            'url' => '',
        ];
    ...
    */
    ...
    function getBlacklist($username){
        $url = "https://a1.easemob.com/".$this->org_name."/".$this->app_name."/users/$username/blocks/users";
        $header=array($this->getTokens());
