...
require('../extend/php-demo/jubaopay/jubaopay.php');
use think\Request;
use think\Db;
class Pingxx extends Common
{
    ...
    public function pay_return(){
        ...
        $jubaopay=new \jubaopay('../extend/php-demo/jubaopay/jubaopay.ini');
        ...
        if($result==1) {
            ...
            file_put_contents("manman.txt", '24', FILE_APPEND);

            echo "success"; // 像服务返回 "success"
        } else {
            file_put_contents("manman1.txt", '243', FILE_APPEND);
