...
//        }
    ...
    public function anchor_info(){
        ...
        $re = DB::name("anchor")->where(['account'=>$account,'password'=>$password])->find();
        if($re){
            $user = DB::name("anchor")->where(["account"=>$account])->find();
            ...
            if($user){
                if($user['is_del']=='1'){
                    ...
                    $user["app_token"] = $member_token;
                    if($user['user_img']==''){
                        $user['img'] = 'http://daylive.tstmobile.com/uploads//image/20180428/3dcc80a5fd88419f2fad5372292f6cd1.png';
                    }else{
...
//            $res = DB::name("control")->where(['control_account'=>$account,'control_password'=>$password])->find();
//            if($res){
//                $user = DB::name("control")->where(['control_account'=>$account])->find();
//                $user['type'] ='2';
