    ...
    public function update_merchants(){
       ...
       $member_id = $params["mid"];
        if(Request::instance()->isAjax()){
            ...
            $merchants["merchants_img"] = empty($params["merchants_img"]) ? true : $params["merchants_img"];
            $merchants["legal_face_img"] = empty($params["legal_face_img"]) ? true : $params["legal_face_img"];
            $merchants["legal_hand_img"] = empty($params["legal_hand_img"]) ? true : $params["legal_hand_img"];
            $merchants["legal_img"] = empty($params["legal_img"]) ? true : $params["legal_img"];
            $merchants["legal_opposite_img"] = empty($params["legal_opposite_img"]) ? true : $params["legal_opposite_img"];
    ...
    public function edit_merchants(){
        ...
        if(Request::instance()->isPost()){
            ...
            $list = DB::name("merchants")->where('member_id',$id)
                ->column('merchants_id,merchants_name,contact_name,contact_mobile,merchants_address,business_img,legal_img,legal_hand_img,legal_face_img,legal_opposite_img,apply_state,pay_state,dashang_scale,sell_scale','member_id');
            $data = $list[$id];
            $this->assign("re",$data);
            return $this->fetch();
        }
